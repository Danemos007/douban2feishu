 ...
 * ```json
 * {
 *   "cookie": "bid=abc123; __utma=123456789; dbcl2=290244208:wI+zvuksP70; ck=Bz9H"
 * }
 * ```
 */
export class UpdateDoubanConfigDto {
   ...
   *
   * @example 'bid=abc123; __utma=123456789; dbcl2=290244208:wI+zvuksP70; ck=Bz9H; frodotk_db=295cad07cf30f1b47c1607176d92d51c'
   */
  @ApiProperty({
    description:
...
export class UpdateFeishuConfigDto {
   ...
   *
   * @example 'xc6jv0oKSkSkzhszgE661dE8xKefCQwb'
   */
  @ApiProperty({
    description:
