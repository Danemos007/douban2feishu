...
describe('ConfigService - Comprehensive Security & Configuration Test Suite', () => {
  ...
  const mockDecryptedCookie = 'll="118282"; bid=Iv-9zz8BFAE';
  const mockDecryptedSecret = 'xc6jv0oKSkSkzhszgE661dE8xKefCQwb';
  ...
  describe('getUserConfig()', () => {
    ...
    it('should return user config with partial credentials (only feishu)', async () => {
      ...
      expect(result.feishu.appId).toBe('cli_a8f5de628bf5500e');
    });
