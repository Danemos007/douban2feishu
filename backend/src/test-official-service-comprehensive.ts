...
class OfficialServiceComprehensiveTest {
  ...
  async testComprehensiveSync(): Promise<void> {
    try {
      ...
      // 配置测试用户
      const userId = 'test-user-290244208';
      const appId = 'cli_a8f5de628bf5500e';
      const appSecret = 'xc6jv0oKSkSkzhszgE661dE8xKefCQwb';
      const appToken = 'BKoxbSycmarpbbsAsrrcsOEHnmh';
      const tableId = 'tblj9s2409ur7Rrx';
