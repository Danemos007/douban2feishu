...
// 测试配置 - 使用真实的飞书应用信息
const TEST_CONFIG = {
  appId: 'cli_your_app_id_here', // 真实的App ID
  appSecret: 'your_app_secret_here', // 真实的App Secret
  appToken: 'your_app_token_here', // 多维表格的App Token
  tableId: 'your_book_table_id', // 书籍表格ID (先测试书籍)
  userId: 'your_user_id', // 豆瓣用户ID
};
