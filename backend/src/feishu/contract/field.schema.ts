 ...
 * 字段property结构 - 宽进严出策略
 */
const FeishuFieldPropertySchema = z.object({
  // 数字字段通用属性
 ...
 */
const FeishuFieldSchema = z.object({
  // 关键字段：严格验证
 ...
 * 飞书字段查询响应Schema
 */
const FeishuFieldsResponseSchema = z.object({
  // API状态：严格验证
 ...
 */
export function extractFieldTypeMapping(fields: FeishuField[]): Record<number, string[]> {
