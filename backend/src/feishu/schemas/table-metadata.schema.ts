 ...
 * 表格基本信息 Schema
 */
export const FeishuTableInfoSchema = z
  .object({
 ...
 * App/多维表格应用信息 Schema
 */
export const FeishuAppInfoSchema = z
  .object({
 ...
 * 表格列表响应 Schema
 */
export const FeishuTablesListResponseSchema = z
  .object({
    code: z
      .number()
      .refine((val) => val === 0, { message: '获取表格列表失败' }),
    msg: z.string(),
    data: z.object({
 ...
 * App信息响应 Schema
 */
export const FeishuAppInfoResponseSchema = z
  .object({
 ...
 * 视图信息 Schema
 */
export const FeishuViewSchema = z
  .object({
 ...
 * 视图列表响应 Schema
 */
export const FeishuViewsListResponseSchema = z
  .object({
    code: z
      .number()
      .refine((val) => val === 0, { message: '获取视图列表失败' }),
    msg: z.string(),
    data: z.object({
 ...
 * 表格统计信息 Schema
 */
export const FeishuTableStatsSchema = z
  .object({
    table_id: z.string(),
 ...
 * 权限信息 Schema
 */
export const FeishuPermissionSchema = z
  .object({
 ...
 * 协作者信息 Schema
 */
export const FeishuCollaboratorSchema = z
  .object({
 ...
 * 协作者列表响应 Schema
 */
export const FeishuCollaboratorsResponseSchema = z
  .object({
    code: z
      .number()
      .refine((val) => val === 0, { message: '获取协作者列表失败' }),
    msg: z.string(),
    data: z.object({
...
export type FeishuTablesListResponse = z.infer<
  typeof FeishuTablesListResponseSchema
>;
...
export type FeishuViewsListResponse = z.infer<
  typeof FeishuViewsListResponseSchema
>;
...
export type FeishuCollaboratorsResponse = z.infer<
  typeof FeishuCollaboratorsResponseSchema
>;
